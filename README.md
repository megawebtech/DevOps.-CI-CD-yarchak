 Домашнее задание к занятию "`Git`" - `Ярчак Александр`
...
В качестве ответа добавьте ссылку на этот коммит в ваш md-файл с решением.Ccs
...
https://github.com/megawebtech/github-hw-git-yarchak/network
